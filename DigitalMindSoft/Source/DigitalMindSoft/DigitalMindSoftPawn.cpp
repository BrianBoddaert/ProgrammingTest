...
#include "DigitalMindSoftWheelFront.h"
#include "DigitalMindSoftWheelRear.h"
...
const FName ADigitalMindSoftPawn::LookUpBinding("LookUp");
const FName ADigitalMindSoftPawn::LookRightBinding("LookRight");
const FName ADigitalMindSoftPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

PRAGMA_DISABLE_DEPRECATION_WARNINGS

ADigitalMindSoftPawn::ADigitalMindSoftPawn()
{
	// Car mesh
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UDigitalMindSoftWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UDigitalMindSoftWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UDigitalMindSoftWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UDigitalMindSoftWheelRear::StaticClass();
...
void ADigitalMindSoftPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ADigitalMindSoftPawn::MoveForward);
...
void ADigitalMindSoftPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void ADigitalMindSoftPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void ADigitalMindSoftPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ADigitalMindSoftPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ADigitalMindSoftPawn::EnableIncarView(const bool bState)
{
...
void ADigitalMindSoftPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void ADigitalMindSoftPawn::BeginPlay()
{
	Super::BeginPlay();
...
void ADigitalMindSoftPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void ADigitalMindSoftPawn::UpdateHUDStrings()
{
...
void ADigitalMindSoftPawn::SetupInCarHUD()
{
...
void ADigitalMindSoftPawn::UpdatePhysicsMaterial()
{
